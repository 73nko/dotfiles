-- Bufferline - pill tabs, Glacier Signal (guia §05, maqueta "Preview target")
  ...
  opts = function()
    ...
    return {
      ...
      highlights = {
        ...
        -- Modified dot
        modified = { fg = c.signal, bg = c.none },
        modified_selected = { fg = c.signal, bg = c.branch_bg },
        modified_visible = { fg = c.signal, bg = c.none },

        -- Diagnostic indicators on tab (err/warn/info/hint)
        error = { fg = c.mint, bg = c.none },
        error_selected = { fg = c.mint, bg = c.branch_bg, bold = true },
        warning = { fg = c.frost, bg = c.none },
        warning_selected = { fg = c.frost, bg = c.branch_bg, bold = true },
        info = { fg = c.azure, bg = c.none },
        info_selected = { fg = c.azure, bg = c.branch_bg, bold = true },
        hint = { fg = c.steel, bg = c.none },
        hint_selected = { fg = c.steel, bg = c.branch_bg, bold = true },
        ...
        close_button_selected = { fg = c.signal, bg = c.branch_bg },
        close_button_visible = { fg = c.muted, bg = c.none },

        -- Tabs (group headers / pinned)
        tab = { fg = c.muted, bg = c.none },
        tab_selected = { fg = c.glow, bg = c.branch_bg, bold = true },
        ...
        -- Pick
        pick = { fg = c.signal, bg = c.none, bold = true, italic = true },
        pick_selected = { fg = c.signal, bg = c.branch_bg, bold = true },
        pick_visible = { fg = c.signal, bg = c.none, bold = true, italic = true },
      },
    }
  end,
}
